...
async function imprimeProcessos(id, processoNome) {
    ...
    processo.innerHTML = `
        ...
        <p class="processo-item processo-item-nome">Matéria em processo: <span>${processoNome}</span></p>
        <button class="processo-item-btn">Click para continuar o processo</button>
    `
