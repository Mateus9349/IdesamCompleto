    ...
    form.innerHTML=`
                    <fieldset class="extra">
                        ...
                        <select data-materiaPrima name="materia-prima" id="">
                            ...
                            <option value="castanha amendoa">Castanha amêndoa</option>
                            <option value="castanha semente">Castanha semente</option>
...
function constroiCardColetas(nome, data, quantidade, preco, ativo){
...
async function listarColetas(materia_prima) {
    ...
    conexaoConvertida.forEach((element) => {
        if (element.materia_prima == materiaPrimaFormatada) {
            containerColetas.appendChild(constroiCardColetas(element.extrativista, element.data_entrada, element.quantidade, element.valor_pago, element.ativo))
        }
    });
}
